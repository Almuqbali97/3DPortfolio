...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt
      ...
      <motion.div
        variants={fadeIn("right", "spring", 0.5 * index, 0.70)}
        className='motion-div w-full green-pink-gradient p-[1px] rounded-[20px] shadow-card'
      >
...
const About = () => {
  return (
    <>
      <SectionWrapper sectionIdName={'about'}>
